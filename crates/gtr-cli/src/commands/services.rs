...
pub async fn run_worker() -> anyhow::Result<()> {
    ...
    worker.register_wf(
        "mayor_wf",
        gtr_temporal::workflows::mayor::mayor_wf,
    );
    worker.register_wf(
        "patrol_wf",
        gtr_temporal::workflows::patrol::patrol_wf,
    );
    worker.register_wf(
        "formula_wf",
    ...
    worker.register_wf(
        "witness_wf",
        gtr_temporal::workflows::witness::witness_wf,
    );
    worker.register_wf(
        "boot_wf",
        gtr_temporal::workflows::boot::boot_wf,
    );
    ...
    worker.register_activity(
        "send_notification",
        gtr_temporal::activities::notification::send_notification,
    );
